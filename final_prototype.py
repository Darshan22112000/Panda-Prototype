...
# URL and credentials
LOGIN_URL = Config.PANDA_URL
PASSWORD = Config.PANDA_PASSWORD

# Sample data for dropdowns
AGENTS = Map_values.AGENTS
AREAS = Map_values.AREAS
PLANS = Map_values.PLANS
...
# Global variable to store the browser driver
driver = None
...
def send_email(first_name, last_name, email, area, plan, login_link):
    msg = Message('Waste Management Made Easy – Choose Your Perfect Panda Plan!🌍',
                  recipients=[email])
    ...
    <p>We are excited to offer you a convenient and cost-effective waste management solution through Panda.</p>
    <p><b>Area:</b> {area}</p>
    <p><b>Plan:</b> {plan}</p>
    <p><b>Why Panda?</b>
    <ul>
        <li>No Hidden Fees</li>
        <li>Free Recycling & Composting</li>
        <li>Flexible Payment Options</li>
    </ul>
    Don’t Miss Out!!!
    These plans are designed to save you money and make waste disposal stress-free. Ready to get started?
    </p>
    <p>Please click the link below to sign up.</p>  <a href="{login_link}">Sign Up Here</a>
    <br></br>
    <img src="https://media.licdn.com/dms/image/v2/C4E0BAQGbLyDq2f3bmw/company-logo_200_200/company-logo_200_200/0/1672909015824/pandaireland_logo?e=1737590400&v=beta&t=F5YAJ5jP8zuYYV73BgO0lWq3n-cpU3miknzyzubw0N4"
             alt="Logo" style="display: block; margin-top: 10px; max-width: 100%; height: 70%;">
...
def perform_login():
    ...
    thread.start()
    # return jsonify({"message": "Login process started. You're being redirected to payment page."})
